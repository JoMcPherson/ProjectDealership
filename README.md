...
1.  Fork this repository https://gitlab.com/mcphersonjoanna/project-dealership.git

2.  Clone the forked repository onto your local computer:
git clone https://gitlab.com/mcphersonjoanna/project-dealership.git

3.  Change directory to your project directory and build and run the project using Docker with these commands:
```
docker volume create car-data
...
##      Service Value Object
 -     The AutomobileVO is a value object that gets data about the automobiles from the inventory using a poller. The service poller automotically polls the inventory microservice for data, so the service microservice is constantly getting the updated data and it checks to see if an automobile has been created so it can create or update the automobile accordingly.

It tracks the href, the VIN which is unique and a max length of 17 characters and the Boolean field of whether or not the car has been sold.
